...
> **Uygulama durumu:** Harita `mockup/packages/client/app/components/game/MapView.tsx` ve `MapBackground.tsx` dosyalarında SVG olarak render edilir. Port koordinatları Mercator projeksiyonuyla hesaplanır (`shared/src/geo/projection.ts`). Darboğazlar glow efektiyle gösterilir.
...
**Toplam:** 15 liman, 29 rota (9 tramontana, 7 kabotaj, 12 fortuna, 1 uzun_kabotaj), 4 darboğaz noktası, 4 bölge
...
| Üretir (ucuz) | Ragusa Tuzu [Yemek] |
| Arzular (pahalı) | Ligurya Mercanı [Lüks] |
| Özel | Diplomatik sığınak; kahvehanede her zaman 1 ekstra fısıltı |
...
| Üretir (ucuz) | Malta Çeliği [Savaş] |
| Arzular (pahalı) | Tunus Zeytinyağı [Yemek] |
| Özel | Kadırga ve tamir ucuz (tersane); Malta ↔ Cezayir Fortuna rotası — Şövalye vs Korsan gerilimi |
...
| Arzular (pahalı) | Ragusa Tuzu [Yemek] |
...
| Arzular (pahalı) | Malta Çeliği [Savaş] |
...
| Üretir (ucuz) | Lübnan Sediri [Savaş] |
| Arzular (pahalı) | Osmanlı Silahı [Savaş] |
...
| Üretir (ucuz) | Mısır Baharatları [Lüks] — tüm çeşitler |
| Arzular (pahalı) | Sahra Altını [Lüks] |
...
| Arzular (pahalı) | Kıbrıs Tuzu [Yemek] |
...
| Arzular (pahalı) | Girit Zeytinyağı [Yemek] |
...
|---------|-------|
| Güç | Osmanlı |
| Üretir (ucuz) | Osmanlı Silahı [Savaş] |
| Arzular (pahalı) | Provence Şarabı [Yemek] |
| Özel | **KORSAN LİMANI** — Kara Bayrak cezasız; ganimet pazarı |
...
> **Uygulama durumu (mockup):** Oyuncu Venedik'te Karaka (kargo 5, güç 2, dayanıklılık 100) ve 200 altınla başlar. Kargoda 1 Murano Camı bulunur.
